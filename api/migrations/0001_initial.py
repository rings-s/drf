    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(blank=True, help_text="User's profile photo.", null=True, upload_to='users/%Y/%m/%d/')),
                ('bio', models.TextField(blank=True, help_text='Short biography of the user', max_length=500, verbose_name='bio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('confirm', 'Confirm'), ('cancelled', 'Cancelled'), ('shipped', 'Shipped'), ('delivered', 'Delivered')], default='pending', max_length=10)),
